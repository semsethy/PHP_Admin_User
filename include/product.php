                ...
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        <div class="sidebar__item">
                            <h4>Categories</h4>
                            <ul>
                                <li class="<?php echo $category_id === null ? 'active' : ''; ?>" data-filter="*"><a href="index.php?p=shop">All</a></li>
                                <?php foreach ($categories as $cat): ?>
                                    <li class="<?php echo $category_id == $cat['id'] ? 'active' : ''; ?>" 
                                        data-filter=".<?php echo strtolower($cat['category_name']); ?>">
                                        <a href="index.php?p=shop&id=<?php echo $cat['id']; ?>"><?php echo htmlspecialchars($cat['category_name']); ?></a>
                                    </li>
                                <?php endforeach; ?>
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row">
                        <?php foreach($products as $product): ?>
                            <div class="col-lg-4 col-md-6 col-sm-6 <?php echo strtolower($product['category_name']); ?>" data-product-id="<?php echo $product['id']; ?>">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="<?php echo "admin/" . $product['main_image_url']; ?>">
                                        <ul class="product__item__pic__hover">
                                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
...
$(document).ready(function(){
    $('.sidebar__item li').click(function(){
        ...
        // This assumes you are using a library like Isotope or just simple CSS class toggling.
